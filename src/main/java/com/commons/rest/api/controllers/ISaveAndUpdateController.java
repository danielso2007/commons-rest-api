...
public interface ISaveAndUpdateController<
	...
	@PostMapping(produces = { IConstantsAPI.APPLICATION_JSON_UTF_8, IConstantsAPI.APPLICATION_XML_UTF_8 })
	...
	@PutMapping(value = "/{id}", produces = { IConstantsAPI.APPLICATION_JSON_UTF_8, IConstantsAPI.APPLICATION_XML_UTF_8 })
	...
	@ResponseStatus(HttpStatus.OK)
	@PatchMapping(value = "/{id}", produces = { IConstantsAPI.APPLICATION_JSON_UTF_8, IConstantsAPI.APPLICATION_XML_UTF_8 })
